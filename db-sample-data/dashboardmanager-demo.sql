...
6	admin	admin@gmail.com	8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918	\N	\N	\N	\N	\N	t	t	t	f	\N	2026-04-30 05:29:59.022851+00	2026-05-08 08:52:06.493562+00
\.
...
105	isochrone_default	大眾運輸等時圈	isochrone	geojson	\N	\N	{"fill-color":["get","color"],"fill-opacity":0.35,"stops_property":[{"key":"stop_name","name":"站名"},{"key":"transit_type","name":"類型"},{"key":"minutes","name":"到達時間(分)"}]}	[{"key":"minutes","name":"分鐘數"},{"key":"time_slot","name":"時段"},{"key":"color","name":"顏色"}]
\.
...
isochrone_default	null	{105}	{"mode":"byParam","byParam":{"xParam":"name","yParam":null}}	static	\N	\N	\N	交通部	呈現指定地點在不同通勤時間內可抵達的雙北大眾運輸等時圈範圍	以大眾運輸等時圈呈現雙北地區的通勤可達性，將「通勤時間成本」轉換為可視化地圖範圍。使用者可自行設定地圖中心點、服務日型、時間參數與交通模式，系統會依據設定計算 15 分鐘、30 分鐘、60 分鐘、90 分鐘至 120 分鐘內可抵達或可出發的區域範圍，協助使用者理解不同通勤時間下的空間可達性差異。\n\n本圖資使用 TDX 大眾運輸路網資料與時刻表資訊，自行整合為 GTFS 資料，並透過 RAPTOR 演算法計算大眾運輸可達範圍。交通模式涵蓋公車、捷運、台鐵，並特別納入跳蛙公車，以反映通勤族於平日尖峰時段常使用的直達型運輸服務。使用者亦可開啟路網顯示，點選站牌查看相關站點與路線資訊。	可用於租屋與通勤決策分析，例如將中心點設定為公司、學校或常去地點，並設定「平日、早上 9 點、抵達」，即可觀察哪些區域能在指定時間內準時抵達目的地。民眾可依自身可接受的通勤時間，搭配租金水準、捷運周邊租金、社會住宅位置與居住環境資料，篩選出更符合預算與生活需求的居住區域。\n\n對政府與研究單位而言，本組件可用於分析雙北大眾運輸可達性、跨區通勤服務涵蓋情形，以及住宅供給與就業地點之間的連結程度，作為公共運輸規劃、居住政策與都市發展決策之參考。	{https://tdx.transportdata.tw/api-service/swagger/basic/2998e851-81d0-40f5-b26d-77e2f5ac4118#/CityBus,https://tdx.transportdata.tw/api-service/swagger/premium/b22c71d8-5af0-4de2-ab0a-be28983fa051#/Estimation,https://tdx.transportdata.tw/api-service/swagger/basic/268fc230-2e04-471b-a728-a726167c1cfc#/Metro,https://tdx.transportdata.tw/api-service/swagger/basic/2cc9b888-a592-496f-99de-9ab35b7fb70d#/TRA}	{king}	2026-04-30 05:35:38.223872+00	2026-05-08 08:37:03.544857+00	map_legend	SELECT unnest(ARRAY['15分鐘', '30分鐘', '60分鐘', '90分鐘', '120分鐘']) AS name, 'fill' AS type	\N	taipei
...
commute_mode_sunburst	\N	{}	{}	static	\N	0	\N	臺北市政府交通局	呈現雙北居民通勤使用交通工具之比例與類型分布	以旭日圖呈現雙北居民通勤方式之組成比例，透過階層式分類展示不同交通工具在整體通勤行為中的占比關係。將通勤方式區分為兩大主要類別：綠運輸（公共運具、非機動運具），並進一步細分為市區公車、捷運、鐵路、私人機車、自用小客車、步行等細項，協助使用者掌握雙北居民日常通勤的運具選擇情形。\n從資料可觀察到，約四成左右的雙北居民外出會使用大眾運輸工具，顯示公共運輸仍是雙北生活圈重要的通勤支撐。若進一步比較臺北市與新北市，可發現臺北市民眾使用公共運具的比例較高，反映臺北市捷運、公車等公共運輸路網較密集，且與日常通勤需求連結程度較高。	可用於分析雙北居民通勤運具選擇與公共運輸依賴程度，協助理解不同城市或區域在交通行為上的差異。民眾可藉此了解自身通勤方式與整體趨勢的關聯，並搭配等時圈、租金與居住地點分析，評估不同區域的大眾運輸便利性；政府與研究單位則可作為公共運輸路網規劃、班距調整、轉乘服務改善與低碳交通政策推動之參考依據。	{https://www-ws.gov.taipei/Download.ashx?u=LzAwMS9VcGxvYWQvMzkwL3JlbGZpbGUvNDMyNzMvODMzMDE4MS83Y2QzNzRlMy02NTNhLTQwNzYtOTY5Mi1mZGEwY2JlMjJiNWUucGRm&n=MTA45bm06ZuZ5YyX5biC5rCR55y%2b5pel5bi46YGL5YW35L2%2f55So54uA5rOBX%2baRmOimgeWIhuaekC5wZGY%3d&icon=.pdf}	{king}	2026-05-02 20:17:46.385266+00	2026-05-02 20:17:46.385266+00	sankey	SELECT x_axis, y_axis, data, color FROM public.commute_mode_flow_edges WHERE city = 'metrotaipei' ORDER BY sort_order, id	\N	metrotaipei
station_rent	null	{106}	{"mode":"byParam","byParam":{"xParam":"line_tw","filterMode":"in"}}	static	\N	\N	\N	臺北市政府地政局	顯示捷運站周邊平均租金。	顯示臺北市捷運站周邊平均租金分布，搭配站點所屬路線色與行政區資訊，用於觀察不同捷運站周邊租金差異與通勤住宅成本。	用於比較捷運站點周邊的租屋價格與通勤位置，作為居住選址、租金政策與交通可達性分析參考。	{https://househunt.land.gov.taipei/app/stationlist}	{king}	2026-05-02 08:00:00+00	2026-05-08 08:55:57.279991+00	map_legend	SELECT unnest(ARRAY['淡水信義線','板南線','松山新店線','中和新蘆線','文湖線']) AS name, 'circle' AS type	\N	taipei
...
isochrone_default	null	{105}	{"mode":"byParam","byParam":{"xParam":"name","yParam":null}}	static	\N	\N	\N	交通部	呈現指定地點在不同通勤時間內可抵達的雙北大眾運輸等時圈範圍	以大眾運輸等時圈呈現雙北地區的通勤可達性，將「通勤時間成本」轉換為可視化地圖範圍。使用者可自行設定地圖中心點、服務日型、時間參數與交通模式，系統會依據設定計算 15 分鐘、30 分鐘、60 分鐘、90 分鐘至 120 分鐘內可抵達或可出發的區域範圍，協助使用者理解不同通勤時間下的空間可達性差異。\n\n本圖資使用 TDX 大眾運輸路網資料與時刻表資訊，自行整合為 GTFS 資料，並透過 RAPTOR 演算法計算大眾運輸可達範圍。交通模式涵蓋公車、捷運、台鐵，並特別納入跳蛙公車，以反映通勤族於平日尖峰時段常使用的直達型運輸服務。使用者亦可開啟路網顯示，點選站牌查看相關站點與路線資訊。	可用於租屋與通勤決策分析，例如將中心點設定為公司、學校或常去地點，並設定「平日、早上 9 點、抵達」，即可觀察哪些區域能在指定時間內準時抵達目的地。民眾可依自身可接受的通勤時間，搭配租金水準、捷運周邊租金、社會住宅位置與居住環境資料，篩選出更符合預算與生活需求的居住區域。\n\n對政府與研究單位而言，本組件可用於分析雙北大眾運輸可達性、跨區通勤服務涵蓋情形，以及住宅供給與就業地點之間的連結程度，作為公共運輸規劃、居住政策與都市發展決策之參考。	{https://tdx.transportdata.tw/api-service/swagger/basic/2998e851-81d0-40f5-b26d-77e2f5ac4118#/CityBus,https://tdx.transportdata.tw/api-service/swagger/premium/b22c71d8-5af0-4de2-ab0a-be28983fa051#/Estimation,https://tdx.transportdata.tw/api-service/swagger/basic/268fc230-2e04-471b-a728-a726167c1cfc#/Metro,https://tdx.transportdata.tw/api-service/swagger/basic/2cc9b888-a592-496f-99de-9ab35b7fb70d#/TRA}	{king}	2026-04-30 05:35:45.998295+00	2026-05-08 08:37:06.598746+00	map_legend	SELECT unnest(ARRAY['15分鐘', '30分鐘', '60分鐘', '90分鐘', '120分鐘']) AS name, 'fill' AS type	\N	metrotaipei
rent_quartiles	\N	{2}	{"mode":"byParam","byParam":{"xParam":"TNAME","yParam":"PNAME"}}	static	\N	0	\N	內政部國土管理署	呈現雙北各行政區不同租屋型態的租金四分位分布	展示指定縣市與行政區之租屋型態結構與租金分布，依「全部」、「整戶（層）」、「獨立套房」與「分租套（雅）房」四種類別呈現各租屋型態的 Q1、中位數與 Q3 租金。民眾可透過縣市與行政區篩選，快速比較不同地區、不同租屋型態的價格區間，了解該區租屋市場的主要租金水準與價格差異。\n採用租金四分位圖呈現資料，相較於單一平均租金，更能反映租金分布的範圍與集中程度。例如中位數可代表該類型租屋的常見價格水準，而 Q1 至 Q3 則可觀察多數租件落在的價格帶，協助使用者判斷該區租金是否偏高、價格落差是否明顯，以及不同房型之間的租金結構差異。	可用於分析雙北居民日常移動時間結構，了解短程生活圈與較長距離通勤需求的比例差異。民眾可藉此評估自身通勤時間是否高於整體移動趨勢，並搭配租金、等時圈與交通可達性資料，衡量居住地點是否符合日常生活與通勤需求。政府與研究單位則可將此作為交通服務規劃、生活圈分析、公共運輸班距調整與跨區通勤政策評估之參考依據。	{https://pip.moi.gov.tw/Publicize/Info/E1080}	{king}	2026-04-29 02:44:30.206957+00	2026-04-29 08:58:38.77403+00	quartile	\n    WITH base AS (\n      SELECT\n        city_name,\n        district_name,\n        house_category,\n        case_count,\n        q1_rent,\n        median_rent,\n        q3_rent\n      FROM public.rent_quartiles_stats\n    ),\n    district_totals AS (\n      SELECT\n        city_name,\n        district_name,\n        SUM(case_count) AS district_case_count\n      FROM base\n      GROUP BY city_name, district_name\n    )\n    SELECT\n      CASE WHEN b.house_category = '不分類' THEN '全部' ELSE b.house_category END AS name,\n      CASE\n        WHEN b.house_category = '不分類' THEN 'pie_chart'\n        WHEN b.house_category = '整戶(層)' THEN 'apartment'\n        WHEN b.house_category = '獨立套房' THEN 'bed'\n        WHEN b.house_category = '分租套(雅)房' THEN 'group'\n        ELSE 'stacked_line_chart'\n      END AS icon,\n\n      b.city_name,\n      b.district_name,\n\n      -- no-data 時把四分位設 NULL，前端才會顯示提示\n      CASE\n        WHEN dt.district_case_count < 40 AND b.district_name <> '全市' THEN NULL\n        ELSE b.q1_rent\n      END AS min,\n      CASE\n        WHEN dt.district_case_count < 40 AND b.district_name <> '全市' THEN NULL\n        ELSE b.q1_rent\n      END AS q1,\n      CASE\n        WHEN dt.district_case_count < 40 AND b.district_name <> '全市' THEN NULL\n        ELSE b.median_rent\n      END AS median,\n      CASE\n        WHEN dt.district_case_count < 40 AND b.district_name <> '全市' THEN NULL\n        ELSE b.q3_rent\n      END AS q3,\n      CASE\n        WHEN dt.district_case_count < 40 AND b.district_name <> '全市' THEN NULL\n        ELSE b.q3_rent\n      END AS max,\n\n      (dt.district_case_count < 40 AND b.district_name <> '全市') AS is_no_data,\n      CASE\n        WHEN dt.district_case_count < 40 AND b.district_name <> '全市'\n          THEN '有效租約樣本 未達40筆 因此無此行政區資料'\n        ELSE NULL\n      END AS no_data_reason,\n\n      CASE b.house_category\n        WHEN '不分類' THEN 1\n        WHEN '整戶(層)' THEN 2\n        WHEN '獨立套房' THEN 3\n        WHEN '分租套(雅)房' THEN 4\n        ELSE 99\n      END AS sort_key\n    FROM base b\n    JOIN district_totals dt\n      ON dt.city_name = b.city_name\n     AND dt.district_name = b.district_name\n    ORDER BY\n      b.city_name,\n      CASE WHEN b.district_name = '全市' THEN 0 ELSE 1 END,\n      b.district_name,\n      sort_key\n  	\N	metrotaipei
commute_time_sunburst	\N	{}	{}	static	\N	0	\N	臺北市政府交通局	呈現雙北居民外出旅次所花費時間的區間分布	以旭日圖呈現雙北居民外出旅次時間之分布情形，透過階層式分類展示不同時間區間在整體外出行為中的占比。將旅次時間區分為「30分鐘內」與「30分鐘以上」兩大主要類別，並進一步細分為未滿10分鐘、10至未滿20分鐘、20至未滿30分鐘、30至未滿40分鐘、40至未滿50分鐘、60分鐘及以上等區間，協助使用者掌握雙北居民日常移動所需時間的整體樣貌。\n從資料可觀察到，雙北居民多數外出旅次集中於30分鐘以內，顯示日常移動多以短程活動為主。不過此資料包含買菜、購物、接送、休閒等一般生活旅次，因此若單獨觀察「通勤／通學」目的，其單趟移動時間可能會高於整體平均，需搭配旅次目的分析與通勤等時圈資料進一步判讀。	可用於分析雙北居民日常移動時間結構，了解短程生活圈與較長距離通勤需求的比例差異。民眾可藉此評估自身通勤時間是否高於整體移動趨勢，並搭配租金、等時圈與交通可達性資料，衡量居住地點是否符合日常生活與通勤需求。政府與研究單位則可將此作為交通服務規劃、生活圈分析、公共運輸班距調整與跨區通勤政策評估之參考依據。	{https://www-ws.gov.taipei/Download.ashx?u=LzAwMS9VcGxvYWQvMzkwL3JlbGZpbGUvNDMyNzMvODMzMDE4MS83Y2QzNzRlMy02NTNhLTQwNzYtOTY5Mi1mZGEwY2JlMjJiNWUucGRm&n=MTA45bm06ZuZ5YyX5biC5rCR55y%2b5pel5bi46YGL5YW35L2%2f55So54uA5rOBX%2baRmOimgeWIhuaekC5wZGY%3d&icon=.pdf}	{king}	2026-05-02 19:56:39.318614+00	2026-05-02 19:56:39.318614+00	sankey	SELECT x_axis, y_axis, data, color FROM public.commute_time_flow_edges WHERE city = 'metrotaipei' ORDER BY sort_order, id	\N	metrotaipei
commute_mode_sunburst	\N	{}	{}	static	\N	0	\N	臺北市政府交通局	呈現臺北居民通勤使用交通工具之比例與類型分布	以旭日圖呈現臺北居民通勤方式之組成比例，透過階層式分類展示不同交通工具在整體通勤行為中的占比關係。將通勤方式區分為兩大主要類別：綠運輸（公共運具、非機動運具），並進一步細分為市區公車、捷運、鐵路、私人機車、自用小客車、步行等細項，協助使用者掌握雙北居民日常通勤的運具選擇情形。\n從資料可觀察到，約四成左右的雙北居民外出會使用大眾運輸工具，顯示公共運輸仍是雙北生活圈重要的通勤支撐。若進一步比較臺北市與新北市，可發現臺北市民眾使用公共運具的比例較高，反映臺北市捷運、公車等公共運輸路網較密集，且與日常通勤需求連結程度較高。	可用於分析臺北居民通勤運具選擇與公共運輸依賴程度，協助理解不同城市或區域在交通行為上的差異。民眾可藉此了解自身通勤方式與整體趨勢的關聯，並搭配等時圈、租金與居住地點分析，評估不同區域的大眾運輸便利性；政府與研究單位則可作為公共運輸路網規劃、班距調整、轉乘服務改善與低碳交通政策推動之參考依據。	{https://www-ws.gov.taipei/Download.ashx?u=LzAwMS9VcGxvYWQvMzkwL3JlbGZpbGUvNDMyNzMvODMzMDE4MS83Y2QzNzRlMy02NTNhLTQwNzYtOTY5Mi1mZGEwY2JlMjJiNWUucGRm&n=MTA45bm06ZuZ5YyX5biC5rCR55y%2b5pel5bi46YGL5YW35L2%2f55So54uA5rOBX%2baRmOimgeWIhuaekC5wZGY%3d&icon=.pdf}	{king}	2026-05-02 20:17:46.385266+00	2026-05-02 20:17:46.385266+00	sankey	SELECT x_axis, y_axis, data, color FROM public.commute_mode_flow_edges WHERE city = 'taipei' ORDER BY sort_order, id	\N	taipei
rent_heatmap	\N	{3,4,102,103,104}	\N	static	\N	\N	\N	內政部國土管理署	呈現指定地點周邊不同租屋型態的租金四分位分布	串接內政部租金查詢系統，使用者可自訂地圖中心點，並選擇 1 公里、2.5 公里或 5 公里等不同查詢半徑，查看指定範圍內的租金四分位資訊。內容包含「全部類別」、「整戶（層）」、「獨立套房」與「分租套（雅）房」共四種租屋型態，並分別呈現 Q1、中位數與 Q3 租金，協助使用者快速掌握周邊租屋價格區間與市場分布情形。\n除組件資訊外，圖資資訊亦搭配自製租金熱力圖，呈現租金資料點的空間分布與密度。使用者可透過篩選不同房屋型態，觀察各類租屋產品在指定區域內的集中程度與價格差異，進一步理解周邊租屋市場結構。	可用於租屋區域評估與居住成本分析，例如使用者可將地點設定為公司、學校、捷運站或有興趣的生活圈，查詢周邊一定半徑內的租金分布，判斷該區租屋價格是否符合預算。搭配大眾運輸等時圈、捷運周邊租金與通勤淨流入資料，也能進一步比較不同居住選擇在「通勤時間」與「租金成本」之間的取捨。\n對城市治理與住宅政策分析而言，則可用於觀察租屋市場熱區、租金資料分布密度與不同租屋型態的價格結構，作為租屋市場監測、住宅補貼評估與居住負擔分析之參考。	{https://moisagis.moi.gov.tw/rent/}	{king}	2026-05-02 09:48:04.973879+00	2026-05-02 12:10:38.15812+00	quartile	\nSELECT\n  name,\n  icon,\n  NULL::text AS city_name,\n  NULL::text AS district_name,\n  is_no_data,\n  no_data_reason,\n  q1_rent AS min,\n  q1_rent AS q1,\n  median_rent AS median,\n  q3_rent AS q3,\n  q3_rent AS max\nFROM public.rent_heatmap_moi_quartiles\nORDER BY sort_key;\n	\N	taipei
trip_purpose_sankey	\N	{}	{}	static	\N	0	\N	臺北市政府交通局	呈現雙北居民外出旅次目的之組成比例與細項分布	以旭日圖呈現雙北居民外出旅次目的之分析結果，透過階層式資料下鑽方式，展示不同外出目的在整體旅次中的占比關係。圖表中心為整體外出旅次，向外依序展開主要分類與細項目的，協助使用者快速理解雙北民眾日常移動的主要原因。\n從資料可觀察到，雙北居民外出旅次中以「通勤／通學」占比最高，約占 44.3%，顯示工作與就學是雙北日常移動的核心需求；其次則為家庭或個人日常活動、購物休閒等生活型旅次。使用者可透過滑鼠 hover 查看各分類的詳細比例與細項資訊，例如單就「通勤」即占雙北居民外出原因近四成，反映通勤需求在都市交通與生活圈規劃中的重要性。	可用於分析雙北居民日常移動行為與交通需求結構，協助理解哪些旅次目的最需要公共運輸、道路系統與生活服務支援。民眾可透過此圖了解自身移動行為與整體趨勢的關聯；政府與研究單位則可將其作為交通政策、通勤服務、公共運輸路網與城市生活機能配置之參考，進一步評估通勤通學需求對都市運輸與居住選擇的影響。	{https://www-ws.gov.taipei/Download.ashx?u=LzAwMS9VcGxvYWQvMzkwL3JlbGZpbGUvNDMyNzMvODMzMDE4MS83Y2QzNzRlMy02NTNhLTQwNzYtOTY5Mi1mZGEwY2JlMjJiNWUucGRm&n=MTA45bm06ZuZ5YyX5biC5rCR55y%2b5pel5bi46YGL5YW35L2%2f55So54uA5rOBX%2baRmOimgeWIhuaekC5wZGY%3d&icon=.pdf}	{king}	2026-05-02 17:06:46.341026+00	2026-05-02 18:53:42.116974+00	sankey	\n    SELECT\n      source AS x_axis,\n      target AS y_axis,\n      value  AS data,\n      color\n    FROM public.component_flow_edges\n    WHERE component_index = 'trip_purpose_sankey'\n      AND city = 'metrotaipei'\n    ORDER BY sort_order, id\n  	\N	metrotaipei
rent_heatmap	\N	{3,4,102,103,104}	\N	static	\N	\N	\N	內政部國土管理署	呈現指定地點周邊不同租屋型態的租金四分位分布	串接內政部租金查詢系統，使用者可自訂地圖中心點，並選擇 1 公里、2.5 公里或 5 公里等不同查詢半徑，查看指定範圍內的租金四分位資訊。內容包含「全部類別」、「整戶（層）」、「獨立套房」與「分租套（雅）房」共四種租屋型態，並分別呈現 Q1、中位數與 Q3 租金，協助使用者快速掌握周邊租屋價格區間與市場分布情形。\n除組件資訊外，圖資資訊亦搭配自製租金熱力圖，呈現租金資料點的空間分布與密度。使用者可透過篩選不同房屋型態，觀察各類租屋產品在指定區域內的集中程度與價格差異，進一步理解周邊租屋市場結構。	可用於租屋區域評估與居住成本分析，例如使用者可將地點設定為公司、學校、捷運站或有興趣的生活圈，查詢周邊一定半徑內的租金分布，判斷該區租屋價格是否符合預算。搭配大眾運輸等時圈、捷運周邊租金與通勤淨流入資料，也能進一步比較不同居住選擇在「通勤時間」與「租金成本」之間的取捨。\n對城市治理與住宅政策分析而言，則可用於觀察租屋市場熱區、租金資料分布密度與不同租屋型態的價格結構，作為租屋市場監測、住宅補貼評估與居住負擔分析之參考。	{https://moisagis.moi.gov.tw/rent/}	{king}	2026-04-29 02:44:30.206957+00	2026-05-02 12:10:38.15812+00	quartile	\nSELECT\n  name,\n  icon,\n  NULL::text AS city_name,\n  NULL::text AS district_name,\n  is_no_data,\n  no_data_reason,\n  q1_rent AS min,\n  q1_rent AS q1,\n  median_rent AS median,\n  q3_rent AS q3,\n  q3_rent AS max\nFROM public.rent_heatmap_moi_quartiles\nORDER BY sort_key;\n	\N	metrotaipei
\.
